                        ...
                        <ul className="flex flex-col gap-4">
                            <li className="flex items-center gap-4">
                                ...
                                <p className="block font-sans text-base font-normal leading-relaxed text-inherit antialiased">
                                    Access to unlimited regular yoga classes
                                </p>
                            </li>
                            <li className="flex items-center gap-4">
                                <span className="rounded-full border border-white/20 bg-white/20 p-1">
                                ...
                                <p className="block font-sans text-base font-normal leading-relaxed text-inherit antialiased">
                                    10% discount on workshops and special events
                                </p>
                            </li>
                            <li className="flex items-center gap-4">
                                <span className="rounded-full border border-white/20 bg-white/20 p-1">
                                ...
                                <p className="block font-sans text-base font-normal leading-relaxed text-inherit antialiased">
                                    Complimentary mat rental for each class
                                </p>
                            </li>
                            <li className="flex items-center gap-4">
                                <span className="rounded-full border border-white/20 bg-white/20 p-1">
                                ...
                                <p className="block font-sans text-base font-normal leading-relaxed text-inherit antialiased">
                                    Monthly newsletter with exclusive content and tips
                                </p>
                            </li>
                    ...
                    <div className="p-0">
                        <ul className="flex flex-col gap-4">
                            ...
                            <li className="flex items-center gap-4">
                                ...
                                <p className="block font-sans text-base font-normal leading-relaxed text-inherit antialiased">
                                    15% discount on workshops and special events
                                </p>
                            </li>
                            <li className="flex items-center gap-4">
                                <span className="rounded-full border border-white/20 bg-white/20 p-1">
                    ...
                    <div className="p-0">
                        <ul className="flex flex-col gap-4">
                            ...
                            <li className="flex items-center gap-4">
                                ...
                                <p className="block font-sans text-base font-normal leading-relaxed text-inherit antialiased">
                                    20% discount on workshops and special events
                                </p>
                            </li>
                            <li className="flex items-center gap-4">
                                <span className="rounded-full border border-white/20 bg-white/20 p-1">
                            ...
                            <li className="flex items-center gap-4">
                                ...
                                <p className="block font-sans text-base font-normal leading-relaxed text-inherit antialiased">
                                    Exclusive members-only merchandise and gifts
                                </p>
                            </li>
                        </ul>
                    </div>
